...
// 不设置 group.protocol，默认 classic
// 不设置 partition.assignment.strategy，默认 RangeAssignor

// 增量协作式重平衡（KIP-480，2.4+）
props.put("group.id", "my-group");
props.put("partition.assignment.strategy",
    "org.apache.kafka.clients.consumer.CooperativeStickyAssignor");
// 仍使用 classic 协议，但用增量 Assignor

// 新消费者组协议（KIP-848，4.0+）
props.put("group.id", "my-group");
props.put("group.protocol", "consumer");  // 关键！
// 服务端 4.0 默认启用，客户端需主动开启
```
...
producerProps.put("transactional.id", "eos-tx-id");
